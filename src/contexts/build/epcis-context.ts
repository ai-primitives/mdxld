// Auto-generated from /home/ubuntu/repos/mdxld/src/contexts/source/epcis-context.jsonld
const context = {$protected:true,$version:1.1,
...
member:{$id:'rdfs:member',$type:'@id',$container:'@set'},
eventTime:{$id:'epcis:eventTime',$type:'xsd:dateTimeStamp'},
recordTime:{$id:'epcis:recordTime',$type:'xsd:dateTimeStamp'},
eventTimeZoneOffset:'epcis:eventTimeZoneOffset',
action:'epcis:action',
certificationInfo:{$id:'epcis:certificationInfo',$type:'@id',$container:'@set'},
bizStep:{$context:{accepting:'cbv:BizStep-accepting',
...
void_shipping:'cbv:BizStep-void_shipping'},$id:'epcis:bizStep',$type:'@vocab'},
disposition:{$context:{active:'cbv:Disp-active',
...
unknown:'cbv:Disp-unknown'},$id:'epcis:disposition',$type:'@vocab'},
bizLocation:{$id:'epcis:bizLocation',$type:'@id'},
readPoint:{$id:'epcis:readPoint',$type:'@id'},
transformationID:{$id:'epcis:transformationID',$type:'@id'},
epcList:{$id:'epcis:epcList',$type:'@id',$container:'@set'},
sourceList:{$id:'epcis:sourceList',$container:'@set',$context:{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
source:{$id:'epcis:sourceOrDestination',$type:'@id'},
type:{$id:'epcis:sourceOrDestinationType',$type:'@vocab',$context:{owning_party:'cbv:SDT-owning_party',
possessing_party:'cbv:SDT-possessing_party',
location:'cbv:SDT-location'}}}},
destinationList:{$id:'epcis:destinationList',$container:'@set',$context:{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
destination:{$id:'epcis:sourceOrDestination',$type:'@id'},
type:{$id:'epcis:sourceOrDestinationType',$type:'@vocab',$context:{owning_party:'cbv:SDT-owning_party',
possessing_party:'cbv:SDT-possessing_party',
location:'cbv:SDT-location'}}}},
persistentDisposition:{$id:'epcis:persistentDisposition',$container:'@set',$context:[{active:'cbv:Disp-active',
available:'cbv:Disp-available',
completeness_verified:'cbv:Disp-completeness_verified',
completeness_inferred:'cbv:Disp-completeness_inferred',
conformant:'cbv:Disp-conformant',
...
stolen:'cbv:Disp-stolen',
unavailable:'cbv:Disp-unavailable',
unknown:'cbv:Disp-unknown'},{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
set:{$id:'epcis:set',$type:'@vocab',$container:'@set'},
unset:{$id:'epcis:unset',$type:'@vocab',$container:'@set'}}]},
quantity:{$id:'epcis:quantity',$type:'xsd:double'},
epcClass:{$id:'epcis:epcClass',$type:'@id'},
uom:'epcis:uom',
quantityList:{$id:'epcis:quantityList',$container:'@set'},
bizTransactionList:{$id:'epcis:bizTransactionList',$container:'@set',$context:{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
bizTransaction:'@id',
type:{$id:'epcis:bizTransactionType',$type:'@vocab',$context:{bol:'cbv:BTT-bol',
cert:'cbv:BTT-cert',
...
upevt:'cbv:BTT-upevt'}}}},
parentID:{$id:'epcis:parentID',$type:'@id'},
childEPCs:{$id:'epcis:childEPCs',$type:'@id',$container:'@set'},
childQuantityList:{$id:'epcis:childQuantityList',$container:'@set'},
inputEPCList:{$id:'epcis:inputEPCList',$container:'@set',$type:'@id'},
outputEPCList:{$id:'epcis:outputEPCList',$container:'@set',$type:'@id'},
inputQuantityList:{$id:'epcis:inputQuantityList',$container:'@set'},
outputQuantityList:{$id:'epcis:outputQuantityList',$container:'@set'},
sensorElementList:{$id:'epcis:sensorElementList',$container:'@set',$context:{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
deviceID:{$id:'epcis:deviceID',$type:'@id'},
deviceMetadata:{$id:'epcis:deviceMetadata',$type:'@id'},
rawData:{$id:'epcis:rawData',$type:'@id'},
dataProcessingMethod:{$id:'epcis:dataProcessingMethod',$type:'@id'},
time:{$id:'epcis:time',$type:'xsd:dateTimeStamp'},
type:'@type',
sensorMetadata:{$id:'epcis:sensorMetadata',$context:{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
startTime:{$id:'epcis:startTime',$type:'xsd:dateTimeStamp'},
endTime:{$id:'epcis:endTime',$type:'xsd:dateTimeStamp'},
bizRules:{$id:'epcis:bizRules',$type:'@id'}}},
sensorReport:{$id:'epcis:sensorReport',$context:{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
type:{$context:{AbsoluteHumidity:'gs1:AbsoluteHumidity',
...
Wavenumber:'gs1:Wavenumber'},$id:'epcis:measurementType',$type:'@vocab'},
exception:{$context:{ALARM_CONDITION:'gs1:ALARM_CONDITION',
ERROR_CONDITION:'gs1:ERROR_CONDITION'},$id:'epcis:exception',$type:'@vocab'},
coordinateReferenceSystem:{$id:'epcis:coordinateReferenceSystem',$type:'@id'},
microorganism:{$id:'epcis:microorganism',$type:'@id'},
chemicalSubstance:{$id:'epcis:chemicalSubstance',$type:'@id'},
time:{$id:'epcis:time',$type:'xsd:dateTimeStamp'},
value:{$id:'epcis:value',$type:'xsd:double'},
component:{$context:{x:'cbv:Comp-x',
y:'cbv:Comp-y',
z:'cbv:Comp-z',
...
altitude:'cbv:Comp-altitude'},$id:'epcis:component',$type:'@vocab'},
stringValue:'epcis:stringValue',
booleanValue:{$id:'epcis:booleanValue',$type:'xsd:boolean'},
hexBinaryValue:{$id:'epcis:hexBinaryValue',$type:'xsd:hexBinary'},
uriValue:{$id:'epcis:uriValue',$type:'@id'},
minValue:{$id:'epcis:minValue',$type:'xsd:double'},
maxValue:{$id:'epcis:maxValue',$type:'xsd:double'},
meanValue:{$id:'epcis:meanValue',$type:'xsd:double'},
sDev:{$id:'epcis:sDev',$type:'xsd:double'},
percRank:{$id:'epcis:percRank',$type:'xsd:double'},
percValue:{$id:'epcis:percValue',$type:'xsd:double'}}}}},
errorDeclaration:{$id:'epcis:errorDeclaration',$context:{$protected:true,
epcis:'https://ref.gs1.org/epcis/',
reason:{$id:'epcis:reason',$type:'@vocab',$context:{did_not_occur:'cbv:ER-did_not_occur',
incorrect_data:'cbv:ER-incorrect_data'}},
correctiveEventIDs:{$id:'epcis:correctiveEventIDs',$type:'@id',$container:'@set'},
declarationTime:{$id:'epcis:declarationTime',$type:'xsd:dateTimeStamp'}}},
eventID:'@id',
...
eventList:{$id:'epcis:eventList'},
children:{$id:'epcis:children',$container:'@set',$type:'@id'}} as const;
