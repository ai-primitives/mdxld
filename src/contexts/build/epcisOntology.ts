...
export const epcisOntology = {
  $context: {
    ...
    jsonldLabel: {
      $id: 'https://ref.gs1.org/epcis/jsonldLabel',
    },
    jsonldUriLabel: {
      $id: 'https://ref.gs1.org/epcis/jsonldUriLabel',
    },
    label: {
  ...
  $graph: [
    {
      $id: 'https://ref.gs1.org/epcis/',
      $type: 'owl:Ontology',
      created: '2021-06-01',
      creator: 'https://gs1.org/',
      label: 'EPCIS Ontology',
      modified: '2021-09-30',
    ...
    },
    {
      ...
      description: 'GS1 is an international organization that sets the global standards in transport and logistics',
      name: 'GS1',
    },
    {
    ...
    },
    {
      ...
      domainIncludes: 'epcis:EPCISEvent',
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'bizTransactionList',
      range: 'epcis:BizTransaction',
      rangeIncludes: 'epcis:BizTransaction',
      term_status: 'stable',
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      jsonldLabel: 'type',
      label: 'bizTransactionType',
      range: 'cbv:BTT',
      rangeIncludes: 'cbv:BTT',
      term_status: 'stable',
    },
    {
    ...
    },
    {
      ...
      rangeIncludes: 'gs1:CertificationDetails',
      term_status: 'stable',
    },
    {
    ...
    },
    {
      ...
      rangeIncludes: 'gs1:IndividualObject',
      term_status: 'stable',
    },
    {
      ...
      rangeIncludes: 'epcis:QuantityElement',
      term_status: 'stable',
    },
    {
      $id: 'epcis:component',
    ...
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'correctiveEventIDs',
      range: 'epcis:EPCISEvent',
      rangeIncludes: 'epcis:EPCISEvent',
      term_status: 'stable',
    },
    {
    ...
    },
    {
      ...
      domainIncludes: 'epcis:ErrorDeclaration',
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'declarationTime',
      range: 'xsd:dateTimeStamp',
      rangeIncludes: 'xsd:dateTimeStamp',
      term_status: 'stable',
    },
    {
      ...
      domainIncludes: 'epcis:EPCISEvent',
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'destinationList',
      range: 'epcis:SourceOrDestination',
      rangeIncludes: 'epcis:SourceOrDestination',
      term_status: 'stable',
    },
    {
      $id: 'epcis:deviceID',
      ...
      rangeIncludes: 'gs1:SensorDevice',
      term_status: 'stable',
    },
    {
    ...
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'epcisBody',
      range: 'epcis:EPCISDocumentBody',
      rangeIncludes: 'epcis:EPCISDocumentBody',
      term_status: 'stable',
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'epcisHeader',
      range: 'epcis:EPCISDocumentHeader',
      rangeIncludes: 'epcis:EPCISDocumentHeader',
      term_status: 'stable',
    },
    {
      $id: 'epcis:errorDeclaration',
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'errorDeclaration',
      range: 'epcis:ErrorDeclaration',
      rangeIncludes: 'epcis:ErrorDeclaration',
      term_status: 'stable',
    },
    {
      $id: 'epcis:eventList',
    ...
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'exception',
      range: 'gs1:SensorAlertType',
      rangeIncludes: 'gs1:SensorAlertType',
      term_status: 'stable',
    },
    {
    ...
    },
    {
      ...
      range: 'epcis:Transformation',
      rangeIncludes: 'epcis:Transformation',
      term_status: 'stable',
    },
    {
      $id: 'epcis:ilmd',
    ...
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'masterData',
      range: 'epcis:MasterData',
      rangeIncludes: 'epcis:MasterData',
      term_status: 'stable',
    },
    {
      $id: 'epcis:maxValue',
    ...
    },
    {
      ...
      range: 'gs1:MeasurementType',
      rangeIncludes: 'gs1:MeasurementType',
      term_status: 'stable',
    },
    {
    ...
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'persistentDisposition',
      range: 'epcis:PersistentDisposition',
      rangeIncludes: 'epcis:PersistentDisposition',
      term_status: 'stable',
    },
    {
      $id: 'epcis:quantity',
    ...
    },
    {
      ...
      domainIncludes: 'epcis:EPCISEvent',
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'sensorElementList',
      range: 'epcis:SensorElement',
      rangeIncludes: 'epcis:SensorElement',
      term_status: 'stable',
    },
    {
      $id: 'epcis:sensorMetadata',
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'sensorMetadata',
      range: 'epcis:SensorMetadata',
      rangeIncludes: 'epcis:SensorMetadata',
      term_status: 'stable',
    },
    {
      $id: 'epcis:sensorReport',
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'sensorReport',
      range: 'epcis:SensorReport',
      rangeIncludes: 'epcis:SensorReport',
      term_status: 'stable',
    },
    {
      $id: 'epcis:set',
    ...
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      jsonldLabel: 'type',
      label: 'sourceOrDestinationType',
      range: 'cbv:SDT',
      rangeIncludes: 'cbv:SDT',
      term_status: 'stable',
    },
    {
      $id: 'epcis:startTime',
    ...
    },
    {
      ...
      isDefinedBy: 'https://ref.gs1.org/epcis/',
      label: 'vocabularyList',
      range: 'owl:Thing',
      rangeIncludes: 'owl:Thing',
      term_status: 'stable',
    },
  ],
} as const;
