...
- event: Upcoming or past event associated with this place, organization, or action. (inherited from PlayAction)
- audience: An intended audience, i.e. a group for whom something was created. (inherited from PlayAction)
